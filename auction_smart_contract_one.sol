...
contract Auction {
    //storage variables
    //static data
    address public owner; //starts the auction, gets highest bid
    uint public startBlock; //demarcate time using block number
    uint public endBlock;
    string public ipfsHash; //i.e. auction title, description,
    uint public bidIncrement;

    //state data
    bool public canceled; //might delete
    address public highestBidder;
    mapping(address => uint256) public fundsByBidder;
    uint public highestBindingBid;
    bool ownerHasWithdrawn; //might delete
    ...
    contract Auction {
        ...
        event LogBid(address bidder, uint bid, address highestBidder,
        uint highestBid, uint highestBindingBid);

        event LogWithdrawal(address withdrawer,
        address withdrawalAccount, uint amount);

        event LogCanceled(); //might delete
    }
